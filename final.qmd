...
# RandomForest Exploratory Data Analysis {#sec-RF}
...
The  accuracy of randomforest is up tp **79.55%** which shows that it give lots of information to the predictors, and th achieving a **sensitivity of 87.506%** and **specificity of 55.55%** ,which mean it have a low ability in predict the negative size of value which is the income >50%.
